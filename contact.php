...
<title>Online BusTicket Reservation</title>
...
<div id="wrapper">
	<div id="header">
    <h1><a href="index.php">UITS Online Bus Pass System</a></h1>
        <ul id="mainnav">
    ...
    <div id="content">
    	<div id="gallerycontainer">
			<div class="portfolio-area" style="margin:0 auto; padding:140px 20px 20px 20px; width:820px;">	
				<div id="contactleft">
					UITS BUS<br>
( UITS TRANSPORT, INCORPORATED)<br>
Location: Dhaka,Mohakhali Bus Terminal<br>
Phone:  +8801234<br><br>

UITS BUS 2<br>
(UITS TRANSPORT INCORPORATED)<br>
Location: Dhaka,Abudullapur Bus Terminal<br>

PHP TRANSPORT<br>
(PHP Group Company)<br>
Phone- +8802999<br><br>

 Kollanpur Bus Terminal in Mirpur  by UITS Transport, Inc.<br>
Location: Mirpur Road, Darusalam,Mirpur-1<br><br>
Contact Numbers: +88995867777<br> <br>
PHP Group Company <br>
Contact Numbers: +88995867777<br> <br>
				</div><br>
				<!-- <div id="contactright">
    ...
    <div id="footer">
	<h4> <a href="contact-us.php">UITS online Bus pass syestem</a></h4>
	<p>Hours of Operation         10:00 am - 12:00 am</p>
	<a href="index.php"><a UITS Online Ticket Reservation ></a>
	<p>&copy; Copyright 2022 UITS | Developed by Jibon<a href="https://www.facebook.com/Ulupara/about_contact_and_basic_info"> <br /></p>
</div>
