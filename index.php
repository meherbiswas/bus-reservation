...
<div id="wrapper">
    ...
    <div id="content">
    	<div id="rotator">
              <ul>
                    <li class="show"><img src="xres/images/jb2/01.jpg" width="" height="394"  alt="" /></li>
...
<div id="logo" style="left: 600px; height: auto; top: 23px; width: 260px; position: absolute; z-index:4;">
    ...
    <div id="featured">
        <div id="items">
            ...
            <p><a href="#"><strong>UITS Bus</strong><br />
            ...
            <p><a href="lodging.php"><strong>From Dhaka to Rajshahi</strong><br />
			Special Lunchbox </a></p>  
			</div>
	...
	<div id="footer">
	<h4> <a href="contact-us.php">UITS online Bus ticket Reservation</a></h4>
	<p>Hours of Operation         10:00 am - 12:00 am</p>
	<a href="index.php"><a UITS Online Ticket Reservation ></a>
	<p>&copy; Copyright 2022 UITS | Developed by Md Sabbir Hossain<a href="https://www.facebook.com/Ulupara/about_contact_and_basic_info"> <br /></p>
</div>
</div>
</body>
</html>
